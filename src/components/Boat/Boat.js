...
const Boat = (props) => {
    function renderBoatPin(props) {
        ...
        let VesselID = this.props.VesselID;
        ...
        this.props.renderBoatPin(VesselID, COG, Latitude, Longitude, VesselName, SOG, boatIcon, boatPin, boatLocation, summary, time)
